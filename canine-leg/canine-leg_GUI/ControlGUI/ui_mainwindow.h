...
public:
    ...
    QPushButton *BT_MAIN_PANEL_MOTOR_ON;
    QPushButton *BT_MAIN_PANEL_CAN_ON;
    QPushButton *BT_MAIN_PANEL_HOME;
    QPushButton *BT_MAIN_PANEL_MOTOR_OFF;
    QLineEdit *LE_MAIN_PANEL_CAN_ON;
    QLineEdit *LE_MAIN_PANEL_MOTOR_ON;
    QLineEdit *LE_MAIN_PANEL_HOME;
    QLineEdit *LE_MAIN_PANEL_MOTOR_OFF;
    ...
    QGroupBox *GB_CUSTOM_BUTTON;
    QPushButton *BT_CUSTOM_BUTTON_CUSTOM_2;
    QPushButton *BT_CUSTOM_BUTTON_CUSTOM_1;
    QPushButton *BT_CUSTOM_BUTTON_CUSTOM_3;
    QPushButton *BT_CUSTOM_BUTTON_CUSTOM_4;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        GB_MAIN_PANEL->setGeometry(QRect(15, -10, 370, 100));
        BT_MAIN_PANEL_MOTOR_ON = new QPushButton(GB_MAIN_PANEL);
        BT_MAIN_PANEL_MOTOR_ON->setObjectName(QString::fromUtf8("BT_MAIN_PANEL_MOTOR_ON"));
        BT_MAIN_PANEL_MOTOR_ON->setGeometry(QRect(100, 40, 80, 50));
        BT_MAIN_PANEL_CAN_ON = new QPushButton(GB_MAIN_PANEL);
        BT_MAIN_PANEL_CAN_ON->setObjectName(QString::fromUtf8("BT_MAIN_PANEL_CAN_ON"));
        BT_MAIN_PANEL_CAN_ON->setGeometry(QRect(10, 40, 80, 50));
        BT_MAIN_PANEL_HOME = new QPushButton(GB_MAIN_PANEL);
        BT_MAIN_PANEL_HOME->setObjectName(QString::fromUtf8("BT_MAIN_PANEL_HOME"));
        BT_MAIN_PANEL_HOME->setGeometry(QRect(280, 40, 80, 50));
        BT_MAIN_PANEL_MOTOR_OFF = new QPushButton(GB_MAIN_PANEL);
        BT_MAIN_PANEL_MOTOR_OFF->setObjectName(QString::fromUtf8("BT_MAIN_PANEL_MOTOR_OFF"));
        BT_MAIN_PANEL_MOTOR_OFF->setGeometry(QRect(190, 40, 80, 50));
        LE_MAIN_PANEL_CAN_ON = new QLineEdit(GB_MAIN_PANEL);
        LE_MAIN_PANEL_CAN_ON->setObjectName(QString::fromUtf8("LE_MAIN_PANEL_CAN_ON"));
        LE_MAIN_PANEL_CAN_ON->setGeometry(QRect(30, 27, 40, 10));
        LE_MAIN_PANEL_MOTOR_ON = new QLineEdit(GB_MAIN_PANEL);
        LE_MAIN_PANEL_MOTOR_ON->setObjectName(QString::fromUtf8("LE_MAIN_PANEL_MOTOR_ON"));
        LE_MAIN_PANEL_MOTOR_ON->setGeometry(QRect(120, 27, 40, 10));
        LE_MAIN_PANEL_HOME = new QLineEdit(GB_MAIN_PANEL);
        LE_MAIN_PANEL_HOME->setObjectName(QString::fromUtf8("LE_MAIN_PANEL_HOME"));
        LE_MAIN_PANEL_HOME->setGeometry(QRect(300, 27, 40, 10));
        LE_MAIN_PANEL_MOTOR_OFF = new QLineEdit(GB_MAIN_PANEL);
        LE_MAIN_PANEL_MOTOR_OFF->setObjectName(QString::fromUtf8("LE_MAIN_PANEL_MOTOR_OFF"));
        LE_MAIN_PANEL_MOTOR_OFF->setGeometry(QRect(210, 27, 40, 10));
        GB_MODEL_MANAGEMENT = new QGroupBox(centralwidget);
        GB_MODEL_MANAGEMENT->setObjectName(QString::fromUtf8("GB_MODEL_MANAGEMENT"));
        GB_MODEL_MANAGEMENT->setGeometry(QRect(10, 670, 381, 110));
        ...
        tableWidget->setGeometry(QRect(10, 110, 380, 192));
        GB_CUBIC = new QGroupBox(centralwidget);
        GB_CUBIC->setObjectName(QString::fromUtf8("GB_CUBIC"));
        GB_CUBIC->setGeometry(QRect(10, 450, 381, 100));
        ...
        GB_PARAMETERS->setGeometry(QRect(10, 310, 381, 130));
        ...
        GB_EXPERIMENT_DATA_MANAGEMENT->setGeometry(QRect(10, 790, 381, 62));
        ...
        GB_CUSTOM_BUTTON = new QGroupBox(centralwidget);
        GB_CUSTOM_BUTTON->setObjectName(QString::fromUtf8("GB_CUSTOM_BUTTON"));
        GB_CUSTOM_BUTTON->setGeometry(QRect(10, 860, 380, 90));
        BT_CUSTOM_BUTTON_CUSTOM_2 = new QPushButton(GB_CUSTOM_BUTTON);
        BT_CUSTOM_BUTTON_CUSTOM_2->setObjectName(QString::fromUtf8("BT_CUSTOM_BUTTON_CUSTOM_2"));
        BT_CUSTOM_BUTTON_CUSTOM_2->setGeometry(QRect(103, 30, 80, 50));
        BT_CUSTOM_BUTTON_CUSTOM_1 = new QPushButton(GB_CUSTOM_BUTTON);
        BT_CUSTOM_BUTTON_CUSTOM_1->setObjectName(QString::fromUtf8("BT_CUSTOM_BUTTON_CUSTOM_1"));
        BT_CUSTOM_BUTTON_CUSTOM_1->setGeometry(QRect(10, 30, 80, 50));
        BT_CUSTOM_BUTTON_CUSTOM_3 = new QPushButton(GB_CUSTOM_BUTTON);
        BT_CUSTOM_BUTTON_CUSTOM_3->setObjectName(QString::fromUtf8("BT_CUSTOM_BUTTON_CUSTOM_3"));
        BT_CUSTOM_BUTTON_CUSTOM_3->setGeometry(QRect(197, 30, 80, 50));
        BT_CUSTOM_BUTTON_CUSTOM_4 = new QPushButton(GB_CUSTOM_BUTTON);
        BT_CUSTOM_BUTTON_CUSTOM_4->setObjectName(QString::fromUtf8("BT_CUSTOM_BUTTON_CUSTOM_4"));
        BT_CUSTOM_BUTTON_CUSTOM_4->setGeometry(QRect(290, 30, 80, 50));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        BT_MAIN_PANEL_MOTOR_ON->setText(QApplication::translate("MainWindow", "MOTOR\n"
                                                                              "ON", nullptr));
        BT_MAIN_PANEL_CAN_ON->setText(QApplication::translate("MainWindow", "CAN\n"
                                                                            "ON", nullptr));
        BT_MAIN_PANEL_HOME->setText(QApplication::translate("MainWindow", "HOME", nullptr));
        BT_MAIN_PANEL_MOTOR_OFF->setText(QApplication::translate("MainWindow", "MOTOR\n"
                                                                               "OFF", nullptr));
        LE_MAIN_PANEL_CAN_ON->setText(QString());
        LE_MAIN_PANEL_MOTOR_ON->setText(QString());
        LE_MAIN_PANEL_HOME->setText(QString());
        LE_MAIN_PANEL_MOTOR_OFF->setText(QString());
        ...
        GB_CUSTOM_BUTTON->setTitle(QApplication::translate("MainWindow", "Custom Button", nullptr));
        BT_CUSTOM_BUTTON_CUSTOM_2->setText(QApplication::translate("MainWindow", "CUSTOM\n"
                                                                                 "2", nullptr));
        BT_CUSTOM_BUTTON_CUSTOM_1->setText(QApplication::translate("MainWindow", "CUSTOM\n"
                                                                                 "1", nullptr));
        BT_CUSTOM_BUTTON_CUSTOM_3->setText(QApplication::translate("MainWindow", "CUSTOM\n"
                                                                                 "3", nullptr));
        BT_CUSTOM_BUTTON_CUSTOM_4->setText(QApplication::translate("MainWindow", "CUSTOM\n"
                                                                                 "4", nullptr));
    } // retranslateUi
