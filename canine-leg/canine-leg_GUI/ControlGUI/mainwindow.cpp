...
{
    ui->LE_MAIN_PANEL_CAN_ON->setStyleSheet("background-color:red");
    ui->LE_MAIN_PANEL_MOTOR_ON->setStyleSheet("background-color:red");
    ui->LE_MAIN_PANEL_MOTOR_OFF->setStyleSheet("background-color:red");
    ui->LE_MAIN_PANEL_HOME->setStyleSheet("background-color:red");
...
{
    ui->LE_MAIN_PANEL_CAN_ON->setStyleSheet("background-color:lightgreen");
...
{
    ui->LE_MAIN_PANEL_MOTOR_ON->setStyleSheet("background-color:lightgreen");
    ui->LE_MAIN_PANEL_MOTOR_OFF->setStyleSheet("background-color:red");
...
{
    ui->LE_MAIN_PANEL_MOTOR_ON->setStyleSheet("background-color:red");
    ui->LE_MAIN_PANEL_MOTOR_OFF->setStyleSheet("background-color:lightgreen");
...
{
    ui->LE_MAIN_PANEL_HOME->setStyleSheet("background-color:lightgreen");
...
void MainWindow::on_BT_PARAMETERS_SET_PARAMS_clicked()
{
    ...
    sharedCommand->userCommand = SETPARAMS;
    sharedMemory->newCommand = true;
}
...
void MainWindow::on_BT_CUBIC_CONTROL_clicked()
{
    ...
    sharedCommand->userCommand = CUBIC_CONTROL;
    sharedMemory->newCommand = true;
}
...
void MainWindow::on_BT_COS_CONTROL_clicked()
{
    ...
    sharedCommand->userCommand = COS_CONTROL;
    sharedMemory->newCommand = true;
}
...
void MainWindow::on_BT_MODEL_LOAD_clicked()
{
    ...
    sharedCommand->userCommand = LOAD_MODEL;
    sharedMemory->newCommand = true;
}
...
void MainWindow::on_BT_MODEL_ONLINE_LEARNING_clicked()
{
    ...
    sharedCommand->userCommand = ONLINE_LEARNING;
    sharedMemory->newCommand = true;
}
